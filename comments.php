...
<h3><?php comment_form_title( 'Dejar un comentario', 'Dejar un comentario a %s' ); ?></h3>
...
<p>Debe estar <a href="<?php echo wp_login_url( get_permalink() ); ?>">identificado</a> para a&ntilde;adir un comentario.</p>
<?php else : ?>
